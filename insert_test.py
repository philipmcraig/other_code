...
clusdir = '/glusterfs/scenario/users/np838619/weatherrescue/'

#filenames = glob.glob(clusdir+'additions_corrections/1900/additions*')
#filenames = pl.asarray(filenames) # list into array
#filenames = pl.sort(filenames) # get filenames in correct order
#filenames = pl.delete(filenames,5)
...
for name in range(filenames.size):
    ...
    newadds.to_csv(clusdir+'additions_corrections/1900/newadds'+filenames[name][85:-4]+'.csv',
